...
class HomeViewModel extends GetxController {
  ...
  void loadMockData() {
    categories.value = [
      ...
      CategoryModel(id: '4', name: 'All Seasons', imageUrl: 'https://images.unsplash.com/photo-1465101178521-c1a9136a3b99'),
    ];
    products.value = [
      ...
      ProductModel(id: '002', name: 'IDSH - 0013', imageUrl: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb', price: 340, isNew: true),
      ProductModel(id: '003', name: 'IDSH - 0014', imageUrl: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca', price: 340),
      ProductModel(id: '004', name: 'IDSH - 0015', imageUrl: 'https://images.unsplash.com/photo-1465101178521-c1a9136a3b99', price: 340),
    ];
  }
